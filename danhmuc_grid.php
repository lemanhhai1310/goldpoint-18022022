                                ...
                                <div class="uk-grid-5 uk-grid-10-m uk-flex-middle" uk-grid>
                                    <div class="uk-width-expand">
                                        <div class="uk-grid-10 uk-flex-middle uk-child-width-auto" uk-grid>
                                            <div>
                                                <a class="danhmuc__icon uk-active" href="danhmuc_grid.php" uk-icon="icon: grid"></a>
                                            </div>
                                            <div>
                                                <a class="danhmuc__icon" href="danhmuc_list.php" uk-icon="icon: list"></a>
                                            </div>
                                            <div>
